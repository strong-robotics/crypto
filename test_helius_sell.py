#!/usr/bin/env python3
"""
Тестовий скрипт для продажу токена через Helius (використовує execute_sell_helius)
"""
...
TOKEN_DECIMALS = 6
TOKEN_AMOUNT = 136_042_061.740147  # Кількість токенів для продажу
KEY_ID = 2
...
async def test_helius_sell():
    """Тестова функція для продажу токена через Helius"""
    print("=" * 80)
    print("🧪 ТЕСТ ПРОДАЖУ ТОКЕНА ЧЕРЕЗ HELIUS")
    print("=" * 80)
...
if __name__ == "__main__":
    result = asyncio.run(test_helius_sell())
